		...
		<div class="col-md-9 col-md-offset-1">
			<div class="panel panel-default">
				<div class="panel-heading">
					渠道管理
					&nbsp;&nbsp;<a class="glyphicon glyphicon-plus" href="{{ url('/admin/user/add') }}">新增渠道</a>
				</div>
						...
						<table class="table">
							...
							@foreach ($lists as $item)
								<tr id="item_{{ $item->id }}">
									...
									<td class="do">
										<a href="{{ url('/admin/user/affiliate/'.$item->id) }}"><button type="button" class="btn btn-default btn-sm">推广记录</button></a>
