		...
		<div class="col-md-10 col-md-offset-1">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="row">
						<form class="form-inline" action="{{ url('/admin/shop/cash') }}" method="get">
					...
					<div class="table-responsive">
						<table class="table">
							...
							<td>
								<a href="{{ url('/admin/shop/cash/'.$item->id) }}"><button type="button" class="btn btn-default btn-sm">详情</button></a>
							</td>
							</tr>
							@endforeach
						</table>
