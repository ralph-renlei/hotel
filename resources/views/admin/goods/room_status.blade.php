				...
				<div class="panel-body">
					...
					<div class="table-responsive">
						<table class="table">
							...
							<div style="width: 200px;height: 100px;float: left;position:relative;border: 3px solid #acddee;background-color: @if($item->room_status == '已预定') #ebdfef @else #acddee @endif">
