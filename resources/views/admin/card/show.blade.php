						...
						<div style="margin-top:15px;">
							<form class="form-horizontal" role="form" method="POST" action="{{ url('/admin/user/card/store') }}">
								...
								<div class="form-group base">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" name="name" id="name" placeholder="请输入名称" value="{{ $item->name }}"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label">月数<span style="color:red">*</span></label>
									<div class="col-sm-5">
										<input type="number" name="months" class="form-control" id="months" placeholder="请输入月数" value="{{ $item->months }}"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label">价格<span style="color:red">*</span></label>
									<div class="col-sm-5">
										<input type="number" name="money" class="form-control" id="money" placeholder="请输入价格" value="{{ $item->money }}"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label">积分</label>
									<div class="col-sm-5">
										<input type="number" name="point" class="form-control" id="point" placeholder="请输入积分" value="{{ $item->point }}"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label">级别</label>
									<div class="col-sm-5">
										<input type="number" name="level" class="form-control" id="level" placeholder="请输入级别" value="{{ $item->level }}"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label">排序</label>
									<div class="col-sm-5">
										<input type="number" name="sort" class="form-control" id="sort" placeholder="请输入序号" value="{{ $item->sort }}"/>
									</div>
								</div>
								<div class="form-group">
