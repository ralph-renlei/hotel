                    ...
                    <div class="modal-body">
                        <form class="form-horizontal" role="form" id="price_store">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input class="Wdate form-control" type="text" onClick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd HH:mm:ss'})" name="start">
                                </div>
                            </div><br><br>
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label">结束时间<span style="color:red">*</span></label>
                                <div class="col-sm-3">
                                    <input class="Wdate form-control" type="text" onClick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd HH:mm:ss'})" name="end">
                                </div>
                            </div><br><br>
                        </form>
                    </div>
