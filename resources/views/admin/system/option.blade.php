					...
					<div class="table-responsive">
						<table class="table">
							...
							@foreach ($list as $item)
								<tr id="item_{{ $item->type_id }}">
									<td class="data">{{ $item->type_id }}</td>
									<td class="data">{{ $item->type_name }}</td>
									<td class="data">{{ $item->type_alias }}</td>
									<td class="do">
										<a href="{{ url('/admin/system/option/'.$item->type_id) }}"><button type="button" class="btn btn-default btn-sm">详情</button></a>
